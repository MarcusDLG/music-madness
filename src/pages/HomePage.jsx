        ...
        <section className="bandCard">
          ...
          <section className="briefDescription">
            ...
            <p>
              ...
              albums based on a science fiction storyline called The Amory Wars,
              a series written by Claudio Sanchez, which has been transcribed
              into a series of comic books as well as a full-length novel. The
              band has released nine studio albums, three live albums, and
        ...
        <section className="bandCard">
          ...
          <section className="briefDescription">
            ...
            <p>
              ...
              worked with a wide range of notable musicians, including Dave
              Grohl and Pharrell Williams.
            </p>
          </section>
        </section>
      </section>
